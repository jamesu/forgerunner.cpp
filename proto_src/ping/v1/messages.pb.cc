...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_ping_2fv1_2fmessages_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_ping_2fv1_2fmessages_2eproto = nullptr;
const ::uint32_t
    TableStruct_ping_2fv1_2fmessages_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::ping::v1::PingRequest, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::ping::v1::PingRequest, _impl_.data_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::ping::v1::PingResponse, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::ping::v1::PingResponse, _impl_.data_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::ping::v1::PingRequest)},
        {9, -1, -1, sizeof(::ping::v1::PingResponse)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::ping::v1::_PingRequest_default_instance_._instance,
    &::ping::v1::_PingResponse_default_instance_._instance,
};
const char descriptor_table_protodef_ping_2fv1_2fmessages_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\026ping/v1/messages.proto\022\007ping.v1\"\033\n\013Pin"
    "gRequest\022\014\n\004data\030\001 \001(\t\"\034\n\014PingResponse\022\014"
    "\n\004data\030\001 \001(\tb\006proto3"
};
static ::absl::once_flag descriptor_table_ping_2fv1_2fmessages_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_ping_2fv1_2fmessages_2eproto = {
    false,
    false,
    100,
    descriptor_table_protodef_ping_2fv1_2fmessages_2eproto,
    "ping/v1/messages.proto",
    &descriptor_table_ping_2fv1_2fmessages_2eproto_once,
    nullptr,
    0,
    2,
    schemas,
    file_default_instances,
    TableStruct_ping_2fv1_2fmessages_2eproto::offsets,
    file_level_enum_descriptors_ping_2fv1_2fmessages_2eproto,
    file_level_service_descriptors_ping_2fv1_2fmessages_2eproto,
};
namespace ping {
namespace v1 {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:ping.v1.PingRequest)
}
inline PROTOBUF_NDEBUG_INLINE PingRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::ping::v1::PingRequest& from_msg)
...
PingRequest::PingRequest(
  ...
  // @@protoc_insertion_point(copy_constructor:ping.v1.PingRequest)
}
inline PROTOBUF_NDEBUG_INLINE PingRequest::Impl_::Impl_(
...
PingRequest::~PingRequest() {
  // @@protoc_insertion_point(destructor:ping.v1.PingRequest)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<0, 1, 0, 32, 2> PingRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GetTable<::ping::v1::PingRequest>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // string data = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(PingRequest, _impl_.data_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string data = 1;
    {PROTOBUF_FIELD_OFFSET(PingRequest, _impl_.data_), 0, 0,
...
// @@protoc_insertion_point(message_clear_start:ping.v1.PingRequest)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* PingRequest::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:ping.v1.PingRequest)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_data().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "ping.v1.PingRequest.data");
          ...
          // @@protoc_insertion_point(serialize_to_array_end:ping.v1.PingRequest)
          return target;
        }
        ...
        ::size_t PingRequest::ByteSizeLong() const {
          const PingRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:ping.v1.PingRequest)
          ::size_t total_size = 0;
...
void PingRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:ping.v1.PingRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:ping.v1.PingRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:ping.v1.PingResponse)
}
inline PROTOBUF_NDEBUG_INLINE PingResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::ping::v1::PingResponse& from_msg)
      : data_(arena, from.data_),
        _cached_size_{0} {}
...
PingResponse::PingResponse(
  ...
  // @@protoc_insertion_point(copy_constructor:ping.v1.PingResponse)
}
inline PROTOBUF_NDEBUG_INLINE PingResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
PingResponse::~PingResponse() {
  // @@protoc_insertion_point(destructor:ping.v1.PingResponse)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<0, 1, 0, 33, 2> PingResponse::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::ping::v1::PingResponse>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // string data = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(PingResponse, _impl_.data_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string data = 1;
    {PROTOBUF_FIELD_OFFSET(PingResponse, _impl_.data_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\24\4\0\0\0\0\0\0"
    "ping.v1.PingResponse"
    "data"
  }},
};

PROTOBUF_NOINLINE void PingResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:ping.v1.PingResponse)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* PingResponse::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:ping.v1.PingResponse)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_data().empty()) {
            const std::string& _s = this_._internal_data();
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "ping.v1.PingResponse.data");
            target = stream->WriteStringMaybeAliased(1, _s, target);
          }
          ...
          // @@protoc_insertion_point(serialize_to_array_end:ping.v1.PingResponse)
          return target;
        }
        ...
        ::size_t PingResponse::ByteSizeLong() const {
          const PingResponse& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:ping.v1.PingResponse)
          ::size_t total_size = 0;
...
void PingResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:ping.v1.PingResponse)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:ping.v1.PingResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_ping_2fv1_2fmessages_2eproto),
         ::std::false_type{});
